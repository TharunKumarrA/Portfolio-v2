...
const TextUnderlineEffect = ({ text }) => {
  ...
  return (
    <div className="relative inline-block">
      <span className="relative text-h5 md:text-h3 font-heading z-20">
        {text}
      </span>
      <div
        className="absolute bottom-2 left-0 h-1 md:h-2 bg-red-500 transition-width duration-500 ease-in-out z-10"
